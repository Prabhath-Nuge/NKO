    ...
    return (
        <div>
            ...
            <div className="container mx-auto p-4 mt-[px]">
                <div data-aos='fade-down' className="border-b text-white py-6 px-4 shadow-md my-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <DashboardBoxComponent title="Products" icon="fa-solid fa-box-open" description={"Detailed information about available products."} link="/products" />
