...
function UsersEmployeeComponent() {
    ...
    useEffect(() => {
        ...
        async function fetchUsers() {
            try {
                const response = await axios.get('/getemps', { withCredentials: true });
        ...
        <div className="container mx-auto p-6">
            <div className="bg-gray-900 shadow-lg rounded-xl overflow-hidden">
                <div className="p-4 border-b border-gray-800 bg-gradient-to-r from-blue-700 to-indigo-700 text-white">
                    ...
                    <p className="text-sm text-gray-300">Manage all Employees.</p>
                </div>
...
export default UsersEmployeeComponent;
